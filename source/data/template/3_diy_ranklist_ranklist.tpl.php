...
0
|| checktplrefresh('./template/default/ranklist/ranklist.htm', './template/default/ranklist/side_left.htm', 1659872713, 'diy', './data/template/3_diy_ranklist_ranklist.tpl.php', './template/acgi_ox0', 'ranklist/ranklist')
...
<?php if($ranklist_setting['member']['available'] && $_G['setting']['ranklist']['membershow']) { ?>
<div class="bm">
<div class="bm_h cl">
<span class="y">
<?php if($_G['uid']) { ?>
