...
0
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/header_common.htm', 1659871892, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/acgi_ox0', 'common/header_home_spacecp')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/pubsearchform.htm', 1659871892, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/acgi_ox0', 'common/header_home_spacecp')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/default/common/header_qmenu.htm', 1659871892, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/acgi_ox0', 'common/header_home_spacecp')
;?>
