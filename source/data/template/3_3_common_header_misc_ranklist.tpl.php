...
0
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/header_common.htm', 1659872713, '3', './data/template/3_3_common_header_misc_ranklist.tpl.php', './template/acgi_ox0', 'common/header_misc_ranklist')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/pubsearchform.htm', 1659872713, '3', './data/template/3_3_common_header_misc_ranklist.tpl.php', './template/acgi_ox0', 'common/header_misc_ranklist')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/default/common/header_qmenu.htm', 1659872713, '3', './data/template/3_3_common_header_misc_ranklist.tpl.php', './template/acgi_ox0', 'common/header_misc_ranklist')
;?>
