...
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;page=<?php echo $_G['page'];?>" class="postalbum_h_back xxmfont iconzuo"></a>
<span class="postalbum_h_picnum">第 <span id="curpic"><?php echo $curaidkey + 1?></span> 张 / 共 <?php echo $count;?> 张</span>
</div>
<ul class="postalbum_c"><?php if(is_array($imglist['url'])) foreach($imglist['url'] as $key => $imgurl) { ?><li class="postalbum_u" id="u_<?php echo $key;?>"><?php $imgurl = getforumimg($imglist[aid][$key], 0, 30000, 30000, 'fixnone');?><img class="postalbum_i" load="0" id="img_<?php echo $key;?>" <?php if($curaidkey == $key) { ?>src="<?php echo $imgurl;?>"<?php } ?> zsrc="<?php echo $imgurl;?>" orig="<?php echo $imglist['url'][$key];?>"/>
</li>
<?php } ?>
</ul>
</div>
