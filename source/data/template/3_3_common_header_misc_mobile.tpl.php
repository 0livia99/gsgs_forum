...
0
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/header_common.htm', 1659880781, '3', './data/template/3_3_common_header_misc_mobile.tpl.php', './template/acgi_ox0', 'common/header_misc_mobile')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/pubsearchform.htm', 1659880781, '3', './data/template/3_3_common_header_misc_mobile.tpl.php', './template/acgi_ox0', 'common/header_misc_mobile')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/default/common/header_qmenu.htm', 1659880781, '3', './data/template/3_3_common_header_misc_mobile.tpl.php', './template/acgi_ox0', 'common/header_misc_mobile')
;?>
