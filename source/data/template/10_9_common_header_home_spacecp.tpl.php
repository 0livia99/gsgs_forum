...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1659872467, '9', './data/template/10_9_common_header_home_spacecp.tpl.php', './template/xxm_twowap', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1659872467, '9', './data/template/10_9_common_header_home_spacecp.tpl.php', './template/xxm_twowap', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1659872467, '9', './data/template/10_9_common_header_home_spacecp.tpl.php', './template/xxm_twowap', 'common/header_home_spacecp')
;?>
