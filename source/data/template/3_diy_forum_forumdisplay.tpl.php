...
0
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/acgi_ox0/forum/forumdisplay_list.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
|| checktplrefresh('./template/acgi_ox0/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1659871899, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'forum/forumdisplay')
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" class="acpost" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发表帖子</a><?php } ?>
...
<?php } else { ?>
<div id="pgbtn" class="pgbtn"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=<?php echo $filter;?>&amp;orderby=<?php echo $_GET['orderby'];?><?php echo $forumdisplayadd['page'];?>&amp;<?php echo $multipage_archive;?>&amp;page=<?php echo $nextpage;?>" hidefocus="true">下一页</a></div>
<?php } } ?>
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecialtmp" class="acpost" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发表帖子</a><?php } ?>
