...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1659872560, '9', './data/template/10_9_common_header_home_space.tpl.php', './template/xxm_twowap', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1659872560, '9', './data/template/10_9_common_header_home_space.tpl.php', './template/xxm_twowap', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1659872560, '9', './data/template/10_9_common_header_home_space.tpl.php', './template/xxm_twowap', 'common/header_home_space')
;?>
