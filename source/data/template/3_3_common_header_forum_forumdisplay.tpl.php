...
0
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/header_common.htm', 1659871899, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/acgi_ox0/common/pubsearchform.htm', 1659871899, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/acgi_ox0/common/header.htm', './template/default/common/header_qmenu.htm', 1659871899, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/acgi_ox0', 'common/header_forum_forumdisplay')
;?>
...
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_top'])) echo $_G['setting']['pluginhooks']['global_cpnav_top'];?><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
...
<div class="row-r b"><?php include template('common/header_m_top'); ?></div>
<div class="clear"></div>
</div>
</div>
<div class="achead">
...
<div class="achdc">
<a href="./" style="margin-top:40px;" class="logo acduang"><?php echo $_G['style']['boardlogo'];?></a><!--margin-top&#x8C03;&#x6574;logo&#x4F4D;&#x7F6E;-->
<div class="acPsearch"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
</div><?php $mnid = getcurrentnav();?><div class="acnv">
<div class="wp1220">
<div id="nv">
<a href="javascript:;" id="qmenu" title="&#x70B9;&#x51FB;" onclick="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">快捷导航</a>
...
<!--<?php echo $_G['setting']['disfixednv_forumindex'];?>-->
<div id="acsubnav">
...
<ul class="cl" id="snav_<?php echo $navid;?>" style="display:none;">
<?php echo $subnav;?>
</ul>
<?php } } } ?>
</div>
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?><?php echo adshow("subnavbanner/a_mu");?><?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?>
