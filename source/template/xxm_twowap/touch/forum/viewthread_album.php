...
.postalbum_i { margin-bottom:-3px; max-width:100%; vertical-align:middle; visibility:hidden; }
	...
	<div class="postalbum">
		<div class="postalbum_h">
			<a href="forum.php?mod=viewthread&tid=$_G[tid]&page=$_G[page]" class="postalbum_h_back xxmfont iconzuo"></a>
		...
		<ul class="postalbum_c">
			...
			<li class="postalbum_u" id="u_$key">
				<!--{eval $imgurl = getforumimg($imglist[aid][$key], 0, 30000, 30000, 'fixnone');}-->
