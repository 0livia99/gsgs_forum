...
<div class="cl">
	<div class="xxm_pay">
		<p class="hm mbw grey"><i class="rq xxmfsft">$paycredits</i> {$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][1]]['unit']}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][1]]['title']}</p>
		<div class="cl">
